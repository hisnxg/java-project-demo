		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tbody>
				...
				<c:forEach items="${p1.dataList}" var="stu">
					<tr id="product1">
                      <td align="center">${stu.stuNo}</td><%-- 学生学号--%>
						<td align="center">${stu.stuName}</td><%-- 学生姓名--%>
						<td align="center">${stu.sex==1?"男":"女"}</td> <%-- 学生性别--%>
                        <td align="center">${stu.phone}</td> <%-- 学生手机号--%>
						<td align="center">${stu.profession} </td><%-- 学生专业--%>
                        <td align="center">${stu.regDate}</td> <%-- 学生注册日期--%>
						<td align="center">
							<a href="/Educational/student/studentServlet?method=findbyid&sid=${stu.stuId}">修改</a>
							<a href="/Educational/student/studentServlet?method=deletebyid&sid=${stu.stuId}">删除</a>
						</td> 				                    
                    </tr>
				</c:forEach>
